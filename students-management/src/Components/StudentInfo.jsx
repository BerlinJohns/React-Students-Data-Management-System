...
const MCA_url="/students/search/?search=Computer Application"



function StudentInfo() {
  const { data, loading, error } = useFetch("/students/search/?search=Computer Application");
  console.log(data)
  return (
    <div>
    {loading ? (
      ...
      <Grid container spacing={2} >
        ...
        <Grid item xs={6}>
        <p className='label'>Name :<b className="name value">{item.name}</b></p>

        <p className='label'>Register Number :<b className='reg-number value'>{item.class_number}</b></p>

        <p className='label'>Blood Group :<b className='blood-group value'>{item.blood_group}</b></p>

        <p className='label'>Parent's PhoneNumber :<b className='blood-group value'>{item.parents_phone_number}</b></p>

        <p className='label'>Gender :<b className='blood-group value'>{item.gender}</b></p>
